...
var sequel = "Harry Potter and the Sorcers Stone";

console.log('Sequel title: ', sequel)
// Initialize a new variable "isFavorite", and assign it to a boolean value indicating
// if the book you chose is your favorite book or not

var isFavorite = true;

console.log('Is this your favorite book? ', isFavorite);
...
var books = ['Peaches', 'Storms', 'Summer', 'Stars', 'Legos'];
...
var belowTwoHundred = [49, 66, 99, 101, 32, 21, 11, 198, 97, 67, 12, 1];
