...
describe("shelf.js", function() {
  ...
  describe("searchShelf", function() {
    it("should tell us if a title is on the shelf", function() {
      ...
      assert.equal(searchShelf("Hyperion", sciFiShelf), true);
      assert.equal(searchShelf("The Fifth Season", sciFiShelf), false);
    });
    ...
    it("should tell us if a title is on a different shelf", function() {
      ...
      assert.equal(searchShelf("Why Not Me?", nonFictionShelf), true);
      assert.equal(searchShelf("Yes Please", nonFictionShelf), false);
    });
  });
});
